...
plt.ylabel("TEC (TECU)", fontsize="large")
plt.title("Event day average TEC with TEC median. Station {}".format(station.upper()), fontsize="large")
plt.xlim(0, 24.0)
...
plt.fill_between(T_ime, -0.301, -0.5, color="r", alpha=0.3)
plt.text(24.1, 0.35, "W=+4", color ="r", fontsize="median")
plt.text(24.1, -0.35, "W=-4", color ="r", fontsize="median")
plt.text(24.1, 0.22, "W=+3", color ="y", fontsize="median")
plt.text(24.1, -0.22, "W=-3", color ="y", fontsize="median")
plt.text(24.1, 0.1, "W=+2", color ="g", fontsize="median")
plt.text(24.1, -0.1, "W=-2", color ="g", fontsize="median")
plt.text(24.1, 0., r"$\mathrm{|W|<1}$", color ="b", fontsize="median")
...
outtab = Table([T_ime, dTEC], names=("Time", "dTEC") )
outtab.write(outdir+"dTEC_table_{}.csv".format(station), format="csv", overwrite=True)
