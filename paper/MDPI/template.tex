...
\Title{Ionospheric Disturbances produced by the 2019 Caribbean Meteoroid}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Ionospheric Disturbances produced by the 2019 Caribbean Meteoroid}
...
\Author{Jorge Tarango-Yong $^{1,\dagger,\ddagger}$\orcidA{}, Mario Rodr\'iguez-Mart\'inez $^{2,\ddagger}$ and Raul Guti\'errez-Zalapa $^{2,}$*}
...
\address{%
$^{1}$ \quad Escuela Nacional de Estudios superiores, UNAM campus Morelia; jorge.tarango@comunidad.unam.mx\\
...
% Keywords
\keyword{Space Sciences; Atmosphere; Ionosphere; UNAVCO; Meteors} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Meteor physical properties}
\label{sec:meteor-prop}
\input{../meteor-properties.tex}

\section{Ionospheric background and sTEC time series}
\label{sec:sTEC-time_series}
\input{../sTEC-time_series}
...
\acknowledgments{The author Tarango-Yong thanks to DGAPA-UNAM by the posdoctoral fellowship, as well as the Laboratorio de Ciencias Geoespacilaes (LACIGE) from the Escuela Nacional de Estudios Superiores -- Morelia for the facilities provided to carry out the calculations of this paper. In addition, Gutiérrez-Zalapa wishes to thanks the Consejo Nacional de Ciencias y Tecnología (CONACyT) for the support in carrying out this research, he also wishes to thanks the Posgrado en Ciencias de la Tierra from the Universidad Nacional Autónoma de México. Finally, M. Rodr\'iguez-Mart\'inez also is grateful for the DGAPA PAPIIT/PAPIME projects (IN118119/PE103419) to the computing support.
}
